...
try {
		...
		const katalog = (teks) => {
             ...
             res = denz.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_© ꪶ 𝑲𝑹𝑰𝒁⇥𝑺𝑬𝑹ꫂ⁩_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
...
denz.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
 ...
 if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Sorry it seems at this time ${NamaOwner} currently Offline\n\n*Reason :* ${alasanafk}\n*Since :* ${heheh.hours} Hour, ${heheh.minutes} Minutes, ${heheh.seconds} second\n\nPlease contact again after Online`, "*_© ꪶ 𝑲𝑹𝑰𝒁⇥𝑺𝑬𝑹ꫂ⁩_*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
		...
		const reply = (teks) => {
			...
			denz.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: ` ꪶ 𝑲𝑹𝑰𝒁⇥𝑺𝑬𝑹ꫂ⁩`,body:"",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/919633687665?text=Hi bro`}}})
...
sendButLocation(from, `${menu}`, " ꪶ 𝑲𝑹𝑰𝒁⇥𝑺𝑬𝑹ꫂ⁩", {jpegThumbnail:gambar,name:""}, [
...
│ ༄ 𝙿𝙻𝙰𝙲𝙴 : 𝚃𝙷𝚁𝙸𝚂𝚂𝚄𝚁 , 𝙺𝚄𝙽𝙽𝙰𝙼𝙺𝚄𝙻𝙰𝙼

│ ༄ 𝙿𝙰𝚂𝙸𝙾𝙽 : 𝙶𝙰𝙼𝙸𝙽𝙶

│ ༄ 𝙸𝙽𝚂𝚃𝙰𝙶𝚁𝙰𝙼 : 𝙺𝙰𝙽𝙽𝙰𝙽𝙱𝚁𝙾_𝙵_𝙵
...
sendButLocation(from, `${menu}`, " ꪶ 𝑲𝑹𝑰𝒁⇥𝑺𝑬𝑹ꫂ⁩", {jpegThumbnail:gambar,name:""}, [{buttonId:`owner`,buttonText:{displayText:'🐦OWNER'},type:1},{buttonId:`script`,buttonText:{displayText:'📒SCRIPT'},type:1}], {contextInfo: { mentionedJid: [otod]}})
       ...
       if (args.length < 1) return reply(`Penggunaan ${prefix}autorespon on/off`)
           ...
           if (c === 'on'){
              ...
              autorespon = false
                    ...
                    reply(`𝚂𝚄𝙲𝙲𝚄𝚂𝚂𝙵𝚄𝙻𝙻𝚈 𝙳𝙴??𝙲𝚃𝙸𝚅𝙴𝙳 𝙰𝚄𝚃𝙾𝚁𝙴𝚂𝙿𝙾𝙽`)
